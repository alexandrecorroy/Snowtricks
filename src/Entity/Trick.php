...
class Trick
{
    ...
    /**
     * @Assert\Valid()
     * @ORM\OneToMany(targetEntity="Picture", mappedBy="trick", cascade={"persist", "remove"}, orphanRemoval=true)
     * @ORM\JoinColumn(nullable=true)
     */
    private $pictures;
    ...
    /**
     * @Assert\Valid()
     * @ORM\OneToMany(targetEntity="Video", mappedBy="trick", cascade={"persist", "remove"}, orphanRemoval=true)
     * @ORM\JoinColumn(nullable=true)
     */
    private $videos;

    /**
     * @ORM\OneToMany(targetEntity="Comment", mappedBy="trick", cascade={"persist", "remove"}, orphanRemoval=true)
     */
    private $comments;
